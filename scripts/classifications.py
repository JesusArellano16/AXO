subClassification = {
    ...
    "Fabricantes de servidores físicos":[
        ...
        "(IBM Corporation)",
        "(xFusion Digital Technologies Co., Limited)",
    ...
    ##DISPOSITIVOS NO IDENTIFICADOS
    "Fabricantes de hardware y componentes para servidores":[
        "(Intel Corporate)",
        "(Quanta Computer Inc.)",
        "(Wistron InforComm (Zhongshan) Corporation)",
        "(ASRock Incorporation)",
        "(Apex, Inc.)",
        "(DongGuan Ramaxel Memory Technology)",
